...
export const dataDir = process.env.OPENCLAW_WORLD_DATA_DIR || path.resolve(projectRoot, "data");
export function resolvePublicDir(rootDir, explicitDir = process.env.OPENCLAW_WORLD_PUBLIC_DIR) {
