import { EQUIPMENT_CATALOG, ROLE_IDS, ROLE_PROFILES } from '../../../shared/world-model.js';
export { ROLE_IDS };
const ROLE_ALIASES = {
    druid: 'druid',
    generalist: 'druid',
...
export function normalizeRoleId(input) {
    const key = String(input || '').trim().toLowerCase();
    return ROLE_ALIASES[key] || 'druid';
}
function defaultEquipmentSlots(roleId) {
...
function reserveEquipmentInventory(roleId) {
...
export function createDefaultBuildState(inputRoleId) {
