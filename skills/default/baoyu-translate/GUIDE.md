...
## 1. 功能定位
- Translates articles and documents between languages with three modes - quick (direct), normal (analyze then translate), and refined (analyze, translate, review, polish). Support...
- 默认档位: 仅全量默认包/手动同步
