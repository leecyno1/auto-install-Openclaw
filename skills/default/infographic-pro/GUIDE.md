...
- 默认档位: 仅全量默认包/手动同步
- 仓库目录: `skills/default/infographic-pro`
- 安装后目录: `~/.openclaw/skills/infographic-pro`
...
## 4. 推荐提问方式
- 请使用 infographic-pro 帮我处理当前任务。
- 如果 infographic-pro 需要额外配置，请先告诉我缺少什么。

## 5. 手动验证
```bash
ls -la ~/.openclaw/skills/infographic-pro
```
