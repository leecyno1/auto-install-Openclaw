...
- 默认档位: 仅全量默认包/手动同步
- 仓库目录: `skills/default/ai-music-generation`
- 安装后目录: `~/.openclaw/skills/ai-music-generation`
...
## 4. 推荐提问方式
- 请使用 ai-music-generation 帮我处理当前任务。
- 如果 ai-music-generation 需要额外配置，请先告诉我缺少什么。

## 5. 手动验证
```bash
ls -la ~/.openclaw/skills/ai-music-generation
```
