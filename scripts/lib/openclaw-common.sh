...
openclaw_sync_lobster_shared_env() {
    ...
    local keys=(
        ...
        OPENCLAW_EXTRA_MODELS
        OPENCLAW_DATA_ROOT
        OPENCLAW_BACKUP_DIR
        OPENCLAW_UPGRADE_BACKUP_DIR
        OPENCLAW_CACHE_DIR
        OPENCLAW_MEDIA_QUOTA_STATE_FILE
        OPENCLAW_TRAFFIC_CONTROL_ENABLED
        OPENCLAW_QUOTA_ENFORCER_MODE
        OPENCLAW_ROUTER_BACKEND
        OPENCLAW_ROUTER_STRATEGY
        OPENCLAW_ROUTER_PRIMARY_MODEL
        OPENCLAW_ROUTER_ADVANCED_MODEL
        OPENCLAW_ROUTER_CODING_MODEL
        OPENCLAW_ROUTER_IMAGE_MODEL
...
openclaw_sync_hermes_env_from_shared() {
    ...
    write_var "OPENCLAW_EXTRA_MODELS" "$(get_shared OPENCLAW_EXTRA_MODELS)"
    write_var "OPENCLAW_DATA_ROOT" "$(get_shared OPENCLAW_DATA_ROOT)"
    write_var "OPENCLAW_BACKUP_DIR" "$(get_shared OPENCLAW_BACKUP_DIR)"
    write_var "OPENCLAW_UPGRADE_BACKUP_DIR" "$(get_shared OPENCLAW_UPGRADE_BACKUP_DIR)"
    write_var "OPENCLAW_CACHE_DIR" "$(get_shared OPENCLAW_CACHE_DIR)"
    write_var "OPENCLAW_MEDIA_QUOTA_STATE_FILE" "$(get_shared OPENCLAW_MEDIA_QUOTA_STATE_FILE)"
    write_var "OPENCLAW_TRAFFIC_CONTROL_ENABLED" "$(get_shared OPENCLAW_TRAFFIC_CONTROL_ENABLED)"
    write_var "OPENCLAW_QUOTA_ENFORCER_MODE" "$(get_shared OPENCLAW_QUOTA_ENFORCER_MODE)"
    write_var "OPENCLAW_ROUTER_BACKEND" "$(get_shared OPENCLAW_ROUTER_BACKEND)"
    write_var "OPENCLAW_ROUTER_STRATEGY" "$(get_shared OPENCLAW_ROUTER_STRATEGY)"
    write_var "OPENCLAW_ROUTER_PRIMARY_MODEL" "$(get_shared OPENCLAW_ROUTER_PRIMARY_MODEL)"
    write_var "OPENCLAW_ROUTER_ADVANCED_MODEL" "$(get_shared OPENCLAW_ROUTER_ADVANCED_MODEL)"
    write_var "OPENCLAW_ROUTER_CODING_MODEL" "$(get_shared OPENCLAW_ROUTER_CODING_MODEL)"
    write_var "OPENCLAW_ROUTER_IMAGE_MODEL" "$(get_shared OPENCLAW_ROUTER_IMAGE_MODEL)"
